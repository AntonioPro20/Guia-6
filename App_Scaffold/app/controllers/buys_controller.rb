class BuysController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @buy.update(buy_params)
        format.html { redirect_to @buy, notice: "Buy was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to buys_path, notice: "Buy was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def buy_params
      params.expect(buy: [ :category, :descrption, :amount ])
    end
end
