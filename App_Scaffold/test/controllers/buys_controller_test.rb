...
class BuysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buy" do
    assert_difference("Buy.count") do
      post buys_url, params: { buy: { amount: @buy.amount, category: @buy.category, descrption: @buy.descrption } }
    end
  ...
  test "should update buy" do
    patch buy_url(@buy), params: { buy: { amount: @buy.amount, category: @buy.category, descrption: @buy.descrption } }
